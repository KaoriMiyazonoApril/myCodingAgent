...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("command rm -rf build", ExecClassification.DESTRUCTIVE),
        ("exec rm -rf build", ExecClassification.DESTRUCTIVE),
        ("nice -n 5 rm -rf build", ExecClassification.DESTRUCTIVE),
        ("timeout 5s rm -rf build", ExecClassification.DESTRUCTIVE),
        ("nohup -- rm -rf build", ExecClassification.DESTRUCTIVE),
        ("stdbuf -oL -eL rm -rf build", ExecClassification.DESTRUCTIVE),
        ("command -- git status", ExecClassification.SAFE_READ_ONLY),
        ("timeout --signal=TERM 5s git status", ExecClassification.SAFE_READ_ONLY),
        ...
        ("node -e 'console.log(1)'", ExecClassification.DYNAMIC_INTERPRETER),
        ("ruby -e 'puts 1'", ExecClassification.DYNAMIC_INTERPRETER),
        ("perl -e 'print 1'", ExecClassification.DYNAMIC_INTERPRETER),
        ("php -r 'echo 1;'", ExecClassification.DYNAMIC_INTERPRETER),
        ...
        ("timeout --unknown 5 rm -rf build", ExecClassification.UNKNOWN),
        ("timeout nope rm -rf build", ExecClassification.UNKNOWN),
        ("timeout -k nope 5 rm -rf build", ExecClassification.UNKNOWN),
        ("stdbuf -o rm -rf build", ExecClassification.UNKNOWN),
        ("stdbuf -o nope rm -rf build", ExecClassification.UNKNOWN),
        ("nice --unknown rm -rf build", ExecClassification.UNKNOWN),
        ("nice -n nope rm -rf build", ExecClassification.UNKNOWN),
        ("command --unknown rm -rf build", ExecClassification.UNKNOWN),
        ("exec --unknown rm -rf build", ExecClassification.UNKNOWN),
